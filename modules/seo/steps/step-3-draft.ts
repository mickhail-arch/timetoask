...
Intent: ${intent}
СТРОГО: объём статьи РОВНО ${charCount} символов. Допуск ±10% (от ${Math.round(charCount * 0.9)} до ${Math.round(charCount * 1.1)} символов). Если текст длиннее — ОБРЕЖЬ. Это КРИТИЧЕСКОЕ требование.
