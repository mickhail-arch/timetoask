...
--color-bg-page	  #FFFFFF	Фон всего приложения, ContentArea  ← canvas-токен; алиас --color-canvas НЕ существует
...
8. Частые ошибки / Common Mistakes
Ошибка	Правильно
var(--color-canvas)	var(--color-bg-page) — токен --color-canvas не существует
var(--color-canvas) (#FFFFFF)	Белый фон страницы всегда через --color-bg-page
bg-[#FFFFFF] в Tailwind	bg-bg-page (Tailwind-алиас) или var(--color-bg-page) в CSS
